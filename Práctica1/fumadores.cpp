...
{
//  std::cout << "Fumador " << num_fumador << " ingrediente " << ingredientes[num_fumador] << std::endl;
   while( true ){
     sem_wait(ingr_disp[num_fumador]);
     std::cout << "retirado por el fumador " << num_fumador<< " ingrediente " << ingredientes[num_fumador] << std::endl;
...
int main(){
   ...
   std::thread estanquero(funcion_hebra_estanquero);
